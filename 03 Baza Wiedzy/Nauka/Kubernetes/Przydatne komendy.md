...
```
wszystkie resources, gdy zapomnisz składni nazwy wylistuej ci wszystkie możlwie zasoby

```bash
kubectl explain pods
kubectl explain pod.sepc/pod.metadata
kubectl explain pod.spec --recursive
```
Pomocne gdy masz problem z składnią konkretnego zasobu w pliku yaml i podobne mozna mieć trzy poziomy szczegółów


Strona z komendami:

[K8s](https://kubernetes.io/docs/reference/kubectl/conventions/)
