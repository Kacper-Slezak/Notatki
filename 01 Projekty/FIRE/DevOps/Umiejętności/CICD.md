...
- [ ] Caching w pipeline'ach (żeby budowało się szybciej)
    
- [ ] Artefakty (zapisywanie i przekazywanie wyników builda)
    
- [ ] Koncepcja GitOps (Pull vs Push model)
    
- [ ] ArgoCD (podstawy, synchronizacja, Application CRD)
