...
- [ ] **Jenkins**:
    ...
    - [ ] Podstawy: Konfiguracja pipeline'ów, praca z zadaniami.
        
    - [ ] Zaawansowane: Pisanie skryptów w `Jenkinsfile`.
        
- [ ] **GitLab CI/CD**:
    
    - [ ] Podstawy: Tworzenie prostych plików `.gitlab-ci.yml`.
        
    - [ ] Zaawansowane: Zmienne, etapy (`stages`), artefakty.
